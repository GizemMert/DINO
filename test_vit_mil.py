...
"""
from infer_vit_mil import ModelInfer
#from model_eval import *  # model training function
from vit_mil_classifier import ViTMiL     
...
def main():
    ...
    RESULT_FOLDER = f"Results_vitmil_fold4"
    ...
    test_files = pd.read_csv(os.path.join(csv_root,"data_fold_4","test.csv"))
    ...
    model_path = "/home/icb/muhammed.dasdelen/last_scemila/25_09_23_transformer_scemila/Results_vitmil_fold4/scemila_transformer_best.pth"
