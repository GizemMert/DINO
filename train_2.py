...
"""
from model_train_2 import ModelTrainer
...
def main():
    ...
    if args.scheduler == 'get_linear_schedule_with_warmup':
        ...
        scheduler = optim.lr_scheduler.OneCycleLR(optimizer, max_lr=float(args.lr) * 10,
                                                  steps_per_epoch=len(dataloaders['train']) / 20, epochs=int(args.ep))
