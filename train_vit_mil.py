...
from dataset import MllDataset       # dataset
...
def main():
    ...
    RESULT_FOLDER = f"Results_vitmil_fold{args.fold}"
    ...
    if checkpoint is None:
        model_path = "/lustre/groups/labs/marr/qscd01/datasets/230824_MLL_BELUGA/vit_best.pth"
    else:
        model_path = None
