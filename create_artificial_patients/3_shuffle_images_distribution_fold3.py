...
output_folder = f'/home/aih/gizem.mert/Dino/DINO/fold3/artificial_data/{experiment_name}/data'
output_folder_csv = f'/home/aih/gizem.mert/Dino/DINO/fold3/artificial_data/{experiment_name}'
...
df_sc_res = pd.read_csv("/home/aih/gizem.mert/Dino/DINO/fold3/train/single_cell_results.csv").drop("patient", axis=1)
